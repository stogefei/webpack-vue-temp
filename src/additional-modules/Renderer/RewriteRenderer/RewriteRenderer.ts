...
// export type RendererHandler = typeof import("bpmn-js/lib/draw/BpmnRenderer").default;
...
class RewriteRenderer extends BaseRenderer {
  ...
  public handlers: Record<string, RendererHandler> | any
  ...
  public drawConnection(parentGfx: SVGElement, connection: Connection): SVGPolylineElement {
    ...
    const h:any = this._renderer(type)
